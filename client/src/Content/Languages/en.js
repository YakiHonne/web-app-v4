const englishTranslation = {
  ...
  AYuUnqd: "An error occured while parsing your address",
  AoUUBDI: "Exit",
  ...
  ACwW9FK: "Replying to",
  Aog1ulK: "Thread",
  AJY8vLC: "An error occured while connecting, please try again.",
  AzVvVt5: "Yakihonne's Chest!",
  AbE7B3Z:
    "Login to Yakihonne's chest, accumulate points by being active on the platform and win precious awards!",
  Amdv4GO: "Log in",
  ATSr8gI: "No, I'm good",
  AXsKX9G: "Join us",
  ABSoIm9: "Discover",
  ...
  AXNt63U: "An error occured while publishing this note.",
  ...
  Acglhzb: "Done!",
  ALEgwqA: "You have tipped",
  AcDgXKI: "Amount",
  Ark6BLW: "Tip message (optional)",
  AGNjoi1: "Save draft?",
  AdeLRrz:
    "You're about to quit your editing, do you wish to save it as a draft?",
  AYO6i7Y: "View",
