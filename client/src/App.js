...
// import { initNDK } from "./Store/Slides/NDKInstance";
...
// import { ConnectNDK } from "./Helpers/Controlers";
...
//   useEffect(() => {
//     let connectNDK = async () => {
//       let ndk = await ConnectNDK(relaysOnPlatform);
//       dispatch(initNDK(ndk));
//     };
//     connectNDK();
//   }, []);
