...
export default function SWhomeAI() {
  return (
    <div>
      <Helmet>
        <title>Yakihonne | Smart widgets AI</title>
        <meta
          name="description"
          content={"Leverage AI capabilities to generate and optimize Smart Widgets for your content. Create intelligent, responsive interactions without deep technical expertise."}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://yakihonne.com/sw-ai`}
        />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Yakihonne" />
        <meta property="og:title" content="Yakihonne | Smart widgets AI" />
        <meta property="twitter:title" content="Yakihonne | Smart widgets AI" />
        <meta
