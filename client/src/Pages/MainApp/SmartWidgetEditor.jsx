...
export default function SmartWidgetEditor() {
  ...
  const [template, setTemplate] = useState(
    state ? state.metadata : getLocalSWv2CDraft()
  );
  const [identifier, setIdentifier] = useState(
    state && state.ops && state.ops === "edit" ? true : false
  );
  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content={"Comprehensive guide to our no-code widget creation platform. Detailed instructions for building custom interactive elements."}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://yakihonne.com/smart-widget-builder`}
        />
        <meta
          property="og:image"
