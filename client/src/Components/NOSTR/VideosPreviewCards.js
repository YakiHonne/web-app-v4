...
export default function VideosPreviewCards({ item, duration = true }) {
  ...
  return (
    <div
      key={item.id}
      className="sc-s-18  fit-container  box-pad-h-m"
      style={{
        position: "relative",
        overflow: "visible",
        columnGap: "16px",
...
//     <Link
//       key={item.id}
//       className="sc-s-18  fit-container fx-scattered box-pad-h-m box-pad-v-m fx-stretch"
//       to={`/videos/${item.naddr}`}
//       style={{ border: "none" }}
//     >
//       <div
//         className="fx-scattered fx-start-v fx-col"
//         style={{
//           rowGap: 0,
//         }}
//       >
