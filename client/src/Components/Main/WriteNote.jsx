  ...
  const publishAsPaid = async (content, tags_) => {
    try {
      ...
      let zapTags = [
        ...
        ["lnurl", import.meta.env.VITE_YAKI_FUNDS_ADDR],
        ["p", import.meta.env.VITE_YAKI_PUBKEY],
        ["e", eventInitEx.id],
      ];
      ...
      const res = await axios(
        `${import.meta.env.VITE_YAKI_FUNDS_ADDR_CALLBACK}?amount=${sats}&nostr=${zapEvent}&lnurl=${import.meta.env.VITE_YAKI_FUNDS_ADDR}`
      );
